...
namespace ComponentUserControl.Buttons
{
    public class DateTimePickerCustom : DateTimePicker
    {
        ...
        //Fields
        //-> Appearance
        private Color skinColor = Color.White;//ColorTranslator.FromHtml(UIKit.PrimaryColor);
        private Color textColor = ColorTranslator.FromHtml(UIKit.SecondaryColor);
        private Color borderColor = ColorTranslator.FromHtml(UIKit.SecondaryColor);
        ...
        protected override void OnCloseUp(EventArgs eventargs)
        {
            ...
            this.borderColor = ColorTranslator.FromHtml(UIKit.SecondaryColor);
            droppedDown = false;
        }
